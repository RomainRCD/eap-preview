...
const TemplateFormulaire = () => {
  ...
  return (
    <div className="min-h-screen bg-muted overflow-x-hidden">
        ...
        <div className="container mx-auto px-3 sm:px-4">
          <div className="grid lg:grid-cols-2 gap-6 lg:gap-12 items-start">
            ...
            <div className="order-1 lg:order-2 lg:sticky lg:top-24">
              <div className="bg-card rounded-xl sm:rounded-2xl shadow-xl border border-border overflow-hidden">
                {/* Form Header */}
                    ...
                    <div className="animate-fade-in">
                      ...
                      <div className="space-y-3 sm:space-y-4 mb-4 sm:mb-6">
                        <div>
                          ...
                          <input type="text" className="input-field text-sm sm:text-base" placeholder="Votre société" />
                        </div>
                        <div>
                          <label className="block text-xs sm:text-sm font-medium text-foreground mb-1 sm:mb-2">SIRET (optionnel)</label>
                          <input type="text" className="input-field text-sm sm:text-base" placeholder="XXX XXX XXX XXXXX" />
                        </div>
                        <div>
                          <label className="block text-xs sm:text-sm font-medium text-foreground mb-1 sm:mb-2">Code postal du chantier</label>
                          <input type="text" className="input-field text-sm sm:text-base" placeholder="Ex: 75001" />
                        </div>
                      </div>
                      ...
                      <div className="flex gap-2 sm:gap-3">
                        ...
                        <Button variant="cta" size="default" className="flex-1 text-sm sm:text-base" onClick={() => setStep(3)}>
                          Continuer
                          <ArrowRight className="w-4 h-4 sm:w-5 sm:h-5 ml-2" />
                        </Button>
                      </div>
                  ...
                  {step === 3 && (
                    <div className="animate-fade-in">
                      ...
                      <div className="space-y-3 sm:space-y-4 mb-4 sm:mb-6">
                        <div className="grid grid-cols-2 gap-2 sm:gap-3">
                          <div>
                            ...
                            <input type="text" className="input-field text-sm sm:text-base" placeholder="Jean" />
                          </div>
                          <div>
                            <label className="block text-xs sm:text-sm font-medium text-foreground mb-1 sm:mb-2">Nom</label>
                            <input type="text" className="input-field text-sm sm:text-base" placeholder="Dupont" />
                          </div>
                        </div>
                        <div>
                          <label className="block text-xs sm:text-sm font-medium text-foreground mb-1 sm:mb-2">Téléphone</label>
                          <input type="tel" className="input-field text-sm sm:text-base" placeholder="06 XX XX XX XX" />
                        </div>
                        <div>
                          <label className="block text-xs sm:text-sm font-medium text-foreground mb-1 sm:mb-2">Email</label>
                          <input type="email" className="input-field text-sm sm:text-base" placeholder="email@entreprise.fr" />
                        </div>
                      </div>
                      ...
                      <div className="flex gap-2 sm:gap-3">
                        ...
                        <Button variant="cta" size="default" className="flex-1 text-sm sm:text-base">
              ...
              {/* Trust Badge */}
              <div className="mt-3 sm:mt-4 flex items-center justify-center gap-3 sm:gap-4 text-xs sm:text-sm text-muted-foreground">
      ...
      {/* Image for mobile */}
      <section className="lg:hidden py-6 sm:py-8">
        <div className="container mx-auto px-3 sm:px-4">
          <img 
            src={heroImage} 
            alt="Chariot télescopique rotatif" 
      ...
      {/* Mini Footer */}
      <footer className="bg-card border-t border-border py-4 sm:py-6">
